...
class ConfidenceGauge(QWidget):
    ...
    def paintEvent(self, event):
        ...
        f2 = QFont("Arial", max(14, int(side * 0.18)))
        f2.setBold(True)
        p.setFont(f2)
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("Copra Quality Analysis System (Laptop Cam)")
    ...
    # ✅ HIDDEN EXIT (DOUBLE CLICK TOP-RIGHT)
    ...
    def do_ai_read(self):
        if not self.is_running:
            return
        import random
        confidence = random.uniform(80.0, 94.9)
